...
The Total steps per day are plotted in a histogram. A table is displayed with comparisons of mean, median and total values for each day of the study.
